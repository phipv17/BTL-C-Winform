...
namespace PMQLKS
{
    public partial class FormThongke : Form
    {
        ...
        private void btnTaobaocao_Click(object sender, EventArgs e)
        {
            ...
            conn.ConnectionString = Properties.Settings.Default.HotelManagerNewConnectionString2;
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Doanhthu2";
            ...
            rpvDoanhthu.LocalReport.ReportPath = "RptDoanhthu2.rdlc";
